...
class ImgToSus:
    ...
    def convert_img(self, gif_speed: float = 0.05) -> str:
        ...
        for y in range(0, height, self.cell_h):
            ...
            print(f"progress {y / height * 100:.2f}%")

        print("Frames generated")
        print(f"Converting time {time() - start} s")
...
if __name__ == '__main__':
    conv = ImgToSus(scale=10)
    conv.load_img("/home/pobopo/Pictures/Wallpapers/t/vou.jpg")
    # conv.load_img("/home/pobopo/Pictures/river.png")
    conv.convert_img()